...
class App extends Component<{TestStore: any}, {}> {
  ...
  handleChangeMonth = (e: boolean) => {

    var store: any = this.props.TestStore;
    var month: number = store.returnMonth;
  ...
  handleChangeDay = (e: boolean) => {

    var store: any = this.props.TestStore;
    var day: number = store.returnDay;
  ...
  handleChangeYear = (e: boolean) => {

    var store: any = this.props.TestStore;
    var year: number = store.returnYear;
