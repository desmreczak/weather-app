...
function MeterPerSecondtoMilesPerHour(mps: number): number {

	return parseFloat((mps * 2.2369).toFixed(2));

}

function properRounding(value: number): number {
	if (value >= 0) {
